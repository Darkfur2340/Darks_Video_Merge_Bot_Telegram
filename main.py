...
async def start_handler(bot: Client, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Creator : @movieskacona", url="https://t.me/movieskacona")],
                [InlineKeyboardButton("Support Group", url="https://t.me/opleecher"),
                 InlineKeyboardButton("Bots Channel", url="https://t.me/@movieskacona")],
...
async def settings_handler(bot: Client, m: Message):
    ...
    if Fsub == 400:
        return
    editable = await m.reply_text("Please Wait ...(If u Wait i will Give AN Chocolate LOL)", quote=True)
...
async def callback_handlers(bot: Client, cb: CallbackQuery):
    if "mergeNow" in cb.data:
        ...
        if len(list_message_ids) < 2:
            await cb.answer("Only One Video You Sent for Merging!(If u dont know about it Then Google LOL)", show_alert=True)
            await cb.message.delete(True)
            return
            ...
            try:
                ...
                await cb.message.edit(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("🤖 Join Updates Channel(Fast Join Or I Will Hack U LOL)", url=invite_link.invite_link)
                            ],
                            [
        ...
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Creator - @movieskacona", url="https://t.me/movieskacona"), InlineKeyboardButton("Support Group", url="https://t.me/opleecher")], [InlineKeyboardButton("Any Query?", url="https://t.me/moveskacona")]]),
            disable_web_page_preview=True
        )
